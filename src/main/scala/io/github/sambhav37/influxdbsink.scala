 ...
 *  Example:
 *  --conf spark.extraListeners=io.github.sambhav37.InfluxDBSink
 *
 ...
 *  use: --conf spark.extraListeners=io.github.sambhav37.InfluxDBSinkExtended
 *
